...
module.exports = ({apps, settings, env, activeEnv, variables}) => async (args) => {
  ...
  promises = microservicesList.map(appName => {
    var write, copyBoilerplate, copyFromProject, writePromises = [], errors = [];
    ...
    copyBoilerplate('lib/bootstrap', 'lib/.', true);

    // ./build/[appName]/lib/middleware/**
    copyBoilerplate('lib/middleware', 'lib/.', true);

    // ./build/[appName]/lib/services/**
    copyBoilerplate('lib/services', 'lib/.', true);

    // ./build/[appName]/lib/utils/**
    copyBoilerplate('lib/utils', 'lib/.', true);

    // ./build/[appName]/lib/decorators/**
    copyBoilerplate('lib/decorators', 'lib/.', true);
    ...
    var data = stringifyAppConfig(apps[appName]);
