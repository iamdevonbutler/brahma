...
console.log( objectAssignDeep({a:1}, {a: 2}) );
console.log( objectAssignDeep({a:{b: 1}}, {a: {b: 2}}) );
console.log( objectAssignDeep({a:{b: 1}}, {a: {b: 2, c: 1}}) );
console.log( objectAssignDeep({a:{b: 1, d: 1}}, {a: {b: 2, c: 1}}) );
console.log( objectAssignDeep({}, {a: 1}) );
console.log( objectAssignDeep({a: 1}, {}) );
console.log( objectAssignDeep({a: 1}, null) );
console.log( objectAssignDeep(null, {a: 1}) );
console.log( objectAssignDeep(null, null) );

console.log( objectAssignDeep({a: 1, c: {a: 1, b: 1}}, {a: 2, b: 1}, {a: 3, c: {a: 2, c: 1}}) );
...
function installDependencies(src) {
  // @todo install w/ env!
  var child = shell.exec(`npm i ${src}`, {async: true});
...
module.exports = ({config, settings, env, variables}) => async (args) => {
  ...
  microservicesList.forEach(appName => {
    ...
    installDependencies(path.join(buildPath, appName));
  });
