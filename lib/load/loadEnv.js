...
module.exports = (envPath, config) => {
  ...
  obj = require(envPath);
  if (!obj || !isType(obj, 'function')) throw `Your env.js file should format as a Function that returns an Object.`;
  obj = obj(config);
  if (!obj) throw `Your env.js file should return an Object.`;
